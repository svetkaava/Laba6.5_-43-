...
bool LightingTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/dev/projects/shaders/shaders6_5/lighting.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/dev/projects/shaders/shaders6_5/lighting.fs")) {
        return false;
    }
