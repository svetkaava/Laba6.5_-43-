...
bool ShadowMapTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/dev/projects/shaders/shaders6_5/shadow_map.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/dev/projects/shaders/shaders6_5/shadow_map.fs")) {
        return false;
    }
